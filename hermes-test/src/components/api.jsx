...
export async function registerUser(userData) {
  ...
  try {
    ...
    const response = await fetch('http://localhost:8100/registro', {
      mode: 'cors',
      credentials: 'include',
      method: 'POST',
      headers: {
...
export async function obtenerDatosActualizados(token) {
  try {
    ...
    const response = await fetch('http://localhost:8100/ingresos-y-gastos', {
      mode: 'cors',
      credentials: 'include',
      method: 'GET',
      headers: {
...
export async function agregarDatosCaja(token, fecha, ingresoEfectivo, ingresoTarjeta, gastos) {
  try {
    ...
    const response = await fetch('http://localhost:8100/agregar-datos-caja', {
      mode: 'cors',
      credentials: 'include',
      method: 'POST',
      headers: {
...
export async function agregarFactura(token, id_proveedor, id_usuario, fecha, total) {
  try {
    ...
    const response = await fetch('http://localhost:8100/facturas', {
      mode: 'cors',
      credentials: 'include',
      method: 'POST',
      headers: {
...
export async function obtenerProveedores(token) {
  try {
    ...
    const response = await fetch('http://localhost:8100/proveedores', {
      mode: 'cors',
      credentials: 'include',
      method: 'GET',
      headers: {
...
export async function obtenerDatosCajas(token) {
  try {
    const response = await fetch('http://localhost:8100/cajas', {
      mode: 'cors',
      credentials: 'include',
      method: 'GET',
      headers: {
